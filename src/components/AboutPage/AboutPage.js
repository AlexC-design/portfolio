    ...
    <div className="page about-page">
      <div className="top-side">
        ...
        <div className="about-text">
          <h1 className="text-bold">Alexandru Ciobotaru</h1>
          ...
          <p>
            ...
            game industry for 4 years before moving into web development.
          </p>
          <br />
          <p>
            I've studied Computer Science at the University of Bucharest, and I
            have focusing mainly on Web Technologies and Frameworks for the last
            two years.
          </p>
          <br />
          <p>
